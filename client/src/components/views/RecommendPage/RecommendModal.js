...
import {
    menuAction_validateInput2,
    menuAction_updateSecond2,
    menuAction_updateThird2,
} from "../../_actions/recommendMenuActions";
...
function RecommendModal() {
    ...
    const onSubmit = () => {
        dispatch(menuAction_validateInput2(inputs));
        if (Object.keys(errors).length === 0) {
            // Insert 2th depth Menu Item
            if (!depth2) {
                dispatch(
                    menuAction_updateSecond2(inputs.path, {
                        ...inputs,
            ...
            // Insert 3th depth Menu Item
                ...
                dispatch(
                    menuAction_updateThird2(inputs.path, {
                        ...inputs,
